...
# data = data[100:]
fig, ax = plt.subplots(2, (width := 3), figsize=(12, 8))
...
histogram_width_reciprocal = [50, 50, 5, 2, 100]
...
ax[1,0].set_title("Expected Democrat Seats")
ax[1,1].set_title("Geographic Score")
ax[1,2].set_title("Regression")
