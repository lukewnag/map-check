...
# or: 53.412, nat lean = 5.527 --> 47.885
    ...
    weights = [1, 20, 20, -2, 0.06, 20, 0.1, -0.15, -20] #TODO
    ...
    minority_heatmap = LinearSegmentedColormap.from_list("custom", district_colors)
    ...
    partisan_heatmap = LinearSegmentedColormap.from_list("custom", district_colors)

    partition.plot(units, figsize=(10, 7), cmap=minority_heatmap) # range color, color scale
    plt.axis('off')

    partition.plot(units, figsize=(10, 7), cmap=partisan_heatmap) # range color, color scale
    plt.axis('off')
