...
projection_code = {'AZ': '2223', 'CO': '2957', 'GA': '4019', 'IL': '4269', 'MI': '6493', 'MN': '26915', 'NC': '6543',
...
def analysis(STATE, YEAR, TOTAL_STEPS, ELECTION_USED):
    ...
    fig.savefig(f"output/{STATE}/ensemble.png")
    figBP.savefig(f"output/{STATE}/boxplot.png")
    figMap.savefig(f"output/{STATE}/map1.png")
    figMap2.savefig(f"output/{STATE}/map2.png")

# OVERNIGHT RUNS
analysis('IL', '2021', 20000, 'PRES20')
# analysis('NC', '2021', 20000, 'PRES20')
analysis('OH', '2021', 20000, 'PRES20')
# analysis('SC', '2021', 15000, 'PRES20')

# TEST
# analysis('NC', '2021', 10, 'PRES20')
# plt.show()